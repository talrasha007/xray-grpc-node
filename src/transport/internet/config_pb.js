...
goog.exportSymbol('proto.xray.transport.internet.TransportProtocol', null, global);
/**
...
proto.xray.transport.internet.TransportConfig.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = /** @type {!proto.xray.transport.internet.TransportProtocol} */ (reader.readEnum());
 ...
 * @return {!proto.xray.transport.internet.TransportProtocol}
 */
proto.xray.transport.internet.TransportConfig.prototype.getProtocol = function() {
  return /** @type {!proto.xray.transport.internet.TransportProtocol} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/**
 * @param {!proto.xray.transport.internet.TransportProtocol} value
 * @return {!proto.xray.transport.internet.TransportConfig} returns this
 */
proto.xray.transport.internet.TransportConfig.prototype.setProtocol = function(value) {
 ...
 * @return {!proto.xray.transport.internet.TransportProtocol}
 */
proto.xray.transport.internet.StreamConfig.prototype.getProtocol = function() {
  return /** @type {!proto.xray.transport.internet.TransportProtocol} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
 ...
 */
proto.xray.transport.internet.StreamConfig.prototype.setProtocol = function(value) {
  return jspb.Message.setProto3EnumField(this, 1, value);
};
...
proto.xray.transport.internet.SocketConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    tcpNoDelay: jspb.Message.getBooleanFieldWithDefault(msg, 18, false),
...
/**
 * optional bool tcp_no_delay = 18;
 * @return {boolean}
 */
proto.xray.transport.internet.SocketConfig.prototype.getTcpNoDelay = function() {
 ...
 * @return {!proto.xray.transport.internet.SocketConfig} returns this
 */
proto.xray.transport.internet.SocketConfig.prototype.setTcpNoDelay = function(value) {
 ...
 * @enum {number}
 */
proto.xray.transport.internet.TransportProtocol = {
  TCP: 0,
  UDP: 1,
  MKCP: 2,
  WEBSOCKET: 3,
